...
Complete index of all 213 native extensions + 1,901 marketplace plugins & skills.
...
Total: 230 native extensions across skills, commands, agents, hooks, and rules.

### Quick Navigation

- **[Skills (213)](#native-skills)** — Workflow automation, code tools, research, design, video, writing
...
213 SKILL.md-based skills. Full list in [CLAUDE.md — Skills section](./CLAUDE.md#2-skills-via-cf-command).

```
cf-code-review, cf-refactor, cf-security-audit, cf-test-writer
cf-devops, cf-mcp-expert, cf-ui-ux
...
cf-tools-pdf-create, cf-tools-md-obsidian
cf-tools-diagram-excalidraw, cf-tools-diagram-flowchart, cf-tools-diagram-infographic, cf-tools-diagram-graphify
cf-tools-git-branch-cleanup, cf-tools-git-create-repo
cf-tools-git-worktree-init, cf-tools-git-worktree-check, cf-tools-git-worktree-cleanup, cf-tools-git-worktree-deliver
cf-tools-system-cleanup-cache, cf-tools-statusline
cf-tools-video-captions, cf-tools-video-compress, cf-tools-video-dub, cf-tools-video-editing-plan
cf-tools-video-extract, cf-tools-video-hook-generator, cf-tools-video-join, cf-tools-video-script
cf-tools-image, cf-tools-image-convert-svg-png, cf-tools-audio, cf-tools-extract-x
cf-content-repurpose, cf-copywriting, cf-scqa, cf-summary-compressor, cf-tone-enforcer
cf-code-optmz-caveman, cf-code-optmz-graph
```
...
**570 plugins** + **1,331 skills** from consolidated marketplace sources.
...
**570 plugins** across categories (merged from sibling repo + aitmpl.com collections).
...
👉 **Full plugins index: [plugins/CATALOG.md](./plugins/CATALOG.md)** (570 plugins)
...
**1,331 marketplace skills** across 20+ categories (numbered 01-20 + cf-* domain folders).
...
| Type | Count | Source |
|------|-------|--------|
| **Skills** | 1,544 | 213 native + 1,331 marketplace |
| **Plugins** | 585 | 15 native external + 570 marketplace (merged) |
| **Commands** | 335 | 5 native + 329 marketplace (cf-prefixed) + 1 pr-workflows |
